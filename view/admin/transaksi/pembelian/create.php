<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Transaksi Pembelian
        <small>/ Tambah Transaksi Pembelian</small>
      </h1>
    </section>
        		...
        		<div class="col-md-6">
        			<div class="form-group">
        				<div class="row">
	        				...
	        				<div class="col-md-8">
	        					<input type="text" name="kode_pembelian" class="form-control" readonly required value="<?php echo $g['kode_beli'] ?>">
	        				</div>
	        			</div>
        			</div>
        			<div class="form-group">
        				<div class="row">
	        				...
	        				<div class="col-md-8">
	        					<input type="text" name="tglbeli" class="form-control" id="datepicker" value="<?php echo date("d/m/Y") ?>" required value="">
	        				</div>
	        			</div>
        			</div>
        			<div class="form-group">
