<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Transaksi Penjualan
        <small>/ Edit Transaksi Penjualan</small>
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Transaksi Penjualan</h3>
        		...
        		<div class="col-md-6">
        			<div class="form-group">
        				<div class="row">
	        				...
	        				<div class="col-md-8">
	        					<input type="text" name="kode_penjualan" class="form-control" readonly required value="<?php echo $value['kode_jual'] ?>">
	        				</div>
	        			</div>
        			</div>
        			<div class="form-group">
        				<div class="row">
	        				...
	        				<div class="col-md-8">
	        					<input type="text" name="tgljual" class="form-control" id="datepicker" value="<?php echo Lib::dateInd($value['tanggal_jual'], true) ?>" required>
	        				</div>
	        			</div>
        			</div>
        		</div>
