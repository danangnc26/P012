<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        ...
        <small>/ Index Laporan Penjualan Barang</small>
      </h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Index Laporan Penjualan Barang</h3>
        ...
        <div class="box-body">
        <form method="get" action="<?php echo app_base.'index_laporan_penjualan' ?>">
        <input type="hidden" name="page" value="index_laporan_penjualan">
        		<div class="row">
	        		<div class="col-md-6">
	        	...
	        	<hr>
	        	<center>
	        		<h4>Laporan Data Penjualan Barang</h4>
	        		<?php
	        		if(!empty($g['dari'])){
	        			$dr = $g['dari'];
	        		}else{
                ...
                <tbody>
	        		...
	        		<tr>
	        			...
	        			<td><?php echo Lib::ind($value['jumlah_jual']*$value['harga_jual']) ?></td>
	        		</tr>
	        		<?php
	        			$sub_total[] = $value['jumlah_jual']*$value['harga_jual'];
	        			}
	        		?>
	        	</tbody>
	        	<tfoot>
    ...
    <script type="text/javascript">
    	 ...
    	 function print()
    	 {
    	 	if($('input[name=type_laporan]').is(':checked')){
    	 		...
    	 		window.open("<?php echo base_url.'function/func.php?func=laporan_penjualan' ?>"+"&type_laporan="+$('input[name=type_laporan]:checked').val()+"&id_kategori="+$('select[name=id_kategori]').val()+"&kode_barang="+$('select[name=kode_barang]').val()+"&dari="+$('input[name=dari]').val()+"&sampai="+$('input[name=sampai]').val(),'_blank');
    	 	}
    	 }
    </script>